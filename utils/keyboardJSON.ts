...
export class Convert {
  public static toKeyboardJSON(json: any): KeyboardJSON {
    return cast(json, r('KeyboardJSON'))
  }

  public static keyboardJSONToJson(value: KeyboardJSON): any {
    return uncast(value, r('KeyboardJSON'))
  }
}
...
const typeMap: any = {
  ...
  KeymapClass: o([{ json: 'c', js: 'c', typ: '' }], false),
  Matrix: o(
    [
